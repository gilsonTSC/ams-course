...
import com.gilsontsc.auth.entity.Permission;
import com.gilsontsc.auth.entity.User;
import com.gilsontsc.auth.repository.PermissionRepository;
import com.gilsontsc.auth.repository.UserRepository;
...
public class AuthApplication {
	...
	private void initUsers(UserRepository userRepository, PermissionRepository permissionRepository,
		...
		User find = userRepository.findByUserName("gil");
		if (find == null) {
